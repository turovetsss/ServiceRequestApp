...
public class CompletedPhotoController : ControllerBase
{
	private const string Bucket = "completed-work-photos";
	private readonly IFileStorageService storage;
	private readonly IRequestService requestService;

	public CompletedPhotoController(IFileStorageService storage, IRequestService requestService)
	{
		this.storage = storage;
		this.requestService = requestService;
	}

	[HttpPost("{requestId:int}/completed-work-photos")]

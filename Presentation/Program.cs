...
builder.Services
	.AddScoped<Domain.Interfaces.IEquipmentPhotoRepository, Infrastructure.Repositories.EquipmentPhotoRepository>();
builder.Services
	.AddScoped<Application.Interfaces.IEquipmentPhotoRepository, Application.Services.EquipmentPhotoRepository>();
builder.Services
	.AddScoped<Domain.Interfaces.IRequestPhotoRepository, Infrastructure.Repositories.RequestPhotoRepository>();
builder.Services
...
builder.Services
	.AddScoped<Application.Interfaces.ICompletedWorkPhotoRepository, Application.Services.CompletedWorkPhotoService>();

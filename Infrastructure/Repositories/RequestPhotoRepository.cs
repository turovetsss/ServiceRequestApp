...
namespace Infrastructure.Repositories
{
    public class RequestPhotoRepository : IRequestPhotoRepository
    {
        ...
        public RequestPhotoRepository(ApplicationDbContext db) => this.db = db;

        public Task<RequestPhoto?> GetByIdAsync(int id) => db.RequestPhotos.FirstOrDefaultAsync(p => p.Id == id);
